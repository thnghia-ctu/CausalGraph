...
consensus_rows, disagreement_rows = runner.aggregate()

print(f"Consensus: {len(consensus_rows)} câu -> {runner.output_dir / 'consensus.csv'}")
print(f"Disagreement: {len(disagreement_rows)} câu -> {runner.output_dir / 'disagreement.csv'}")
